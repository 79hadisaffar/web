...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2016 at 01:29 PM
...
(7, 'گوشی خوبیه', 'نظر اول', '', 'قوت', 'باتری ضعیف', 0, 0, 16, 'a:5:{i:1;s:2:"3 ";i:2;s:2:"4 ";i:3;s:2:"2 ";i:4;s:2:"3 ";i:5;s:2:"3 ";}', 1, 1),
...
INSERT INTO `tbl_product` (`id`, `title`, `price`, `cat`, `introduction`, `tedad_mojood`, `discount`, `special`, `time_special`, `onlyclicksite`, `viewd`, `colors`, `garantee`, `idcategory`, `weight`) VALUES
